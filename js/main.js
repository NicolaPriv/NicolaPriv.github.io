...
const W = [
  ...
  {id:'magnetologues',t:'Magnetologues',c:'performance',m:'With Giacomo Lepri \u00b7 TENOR 2024 \u00b7 Zurich',img:B+'full_OFpRBhun.png',bd:'<p>Performance for two Staccos \u2014 one runs four AI models, the other controls Ambisonics on ZhdK\u2019s 24-channel system.</p><div class="video-embed"><iframe src="https://www.youtube.com/embed/Bt3O-jhSqiU" allowfullscreen></iframe></div>',g:[]},
  ...
  {id:'weird',t:'W.E.I.R.D. Suite',c:'performance',m:'Blackwood Gallery \u00b7 Toronto 2019\u20132021',img:B+'full_0NFMCAwF.png',bd:'<p>W.E.I.R.D. (Western, Educated, Industrialised, Rich, Democratic) is a suite for piano solo combining data mining with generative musical notation. Tweets containing specific keywords are downloaded in real time and affect the generation of the score, drawing on Zygmunt Bauman\u2019s sociological perspective on postmodernity.</p><p>The suite consists of three movements:</p><p><strong>I. Uncertainty</strong> \u2014 Tweets trigger the creation of the composition bar by bar. Once most bars are generated, the soloist begins to play while the tweets shift the score between a finished version and a less refined one, making the score itself uncertain.</p><p><strong>II. Emergency</strong> \u2014 The focus moves to the volume of tweets containing the keyword. The density of social media activity directly shapes the musical texture.</p><p><strong>III. Identity</strong> \u2014 The longest and most articulated movement, developed after the first lockdown. The performer uses a specifically designed looper that juxtaposes the last four musical phrases as the score changes \u2014 a metaphor for how we develop our identities, combining chance, the pressure of society, and the compounding of our choices.</p>',g:[]},
  ...
  {id:'grandi-navi',t:'Grandi Navi',c:'performance',m:'Live electronics and trombone \u00b7 Venice 2021',img:B+'full_0NFMCAwF.png',bd:'<p>Improvisation with Alberto Novello, Alessandro Gambato, Mattia Pizzato. Sound projection by Julian Scordato. Pase Platform, Venice.</p><div class="video-embed"><iframe src="https://player.vimeo.com/video/559910591" allowfullscreen></iframe></div>',g:[]},
